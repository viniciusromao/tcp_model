...
A figura \ref{fig:tdp_macro} apresenta o comportamento de uma conexão TCP, descrito acima, em mais detalhes. Defini-se 
...
\begin{figure}[ht]
  ...
  \label{fig:tdp_macro}
  \caption{Evoluçao do tamanho da janela quando perdas de pacotes sao TDs.}
\end{figure}
